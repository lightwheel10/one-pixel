...
export function Process() {
  const steps = [
    { n: '01', t: 'Discovery',      tag: 'Listen', d: 'A 30 minute call. We dig into your business, your audience, and the metric that actually matters. No pitch deck.', time: 'Week 1',     deliverables: ['Kickoff brief', 'Audience map', 'Success metric'] },

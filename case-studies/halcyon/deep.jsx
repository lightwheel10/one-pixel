...
export function HudsonMap() {
  ...
  const pins = [
    { x: 38, y: 18, label: 'Hudson',      props: 3 },
    { x: 42, y: 26, label: 'Rhinebeck',   props: 2, featured: true },
    { x: 46, y: 36, label: 'Tivoli',      props: 1 },
    { x: 44, y: 46, label: 'Hyde Park',   props: 2 },
    { x: 52, y: 56, label: 'Beacon',      props: 4 },
    { x: 50, y: 64, label: 'Cold Spring', props: 5, featured: true, home: true },
    { x: 56, y: 70, label: 'Garrison',    props: 3, featured: true },
    { x: 38, y: 72, label: 'Philipstown', props: 2 },
    { x: 30, y: 50, label: 'Millbrook',   props: 2 },
    { x: 64, y: 80, label: 'Stone Ridge', props: 1 },
  ];
      ...
      <div className="hc-shell">
        <div className="hc-section-head">
          ...
          <div>
            ...
            <p className="hc-section-sub">
              We work along the Hudson, between Cold Spring and Hudson — a 90-minute corridor we’ve walked, drawn, and revisited for sixty-two years. Hover a town to see what we’ve placed there.
            </p>
          </div>
        </div>
        ...
        <div className="hc-map-frame">
          <svg className="hc-map-svg" viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid slice">
            ...
            <text x="20" y="30" fontFamily="JetBrains Mono" fontSize="10" letterSpacing="3" fill="#8C857A">HUDSON VALLEY · NY</text>
        ...
        <div className="hc-map-legend">
          ...
          <div>
            ...
            <div className="l">Generations of Halcyons</div>
          </div>
          <div>
  ...
  const members = [
    {
      ...
      bio: 'Opened a one-room office on Main Street with a typewriter, a phone, and a list of seventeen names. The list was, he insisted, the only inventory worth keeping.',
      img: HC_PHOTOS.fam1,
    },
    {
      n: 'II',
      ...
      bio: 'Joined her father out of Vassar. Listed our first estate in The Times in 1992. Still walks every property with a measuring tape and a notebook.',
      img: HC_PHOTOS.fam2,
    },
    {
      n: 'III',
    ...
    <section className="hc-section" id="family">
      <div className="hc-shell">
        ...
        <div className="hc-family-grid">
          {members.map((m, i) => (
            <div key={i} className="hc-family-member">
              ...
              <div className="hc-family-name"><em>{m.em}</em>{m.name.replace(m.em, '')}</div>
        ...
        <div className="hc-pullquote">
          <q>My grandfather sold houses with a handshake. My mother insisted on knowing every neighbor before she ever knocked. The work hasn’t changed much.</q>
          <div className="attr">— Mara Halcyon · Principal Broker · 2024</div>
        </div>
      </div>
    </section>
  );
  ...
  const items = [
    {
      ...
      title: <>On the <em>quiet houses</em> of Cold Spring</>,
      blurb: 'A walking essay through Main Street’s thirteen pre-war homes — and the families that have, against all odds, kept them.',
    ...
    },
    {
      ...
      title: <>A note on <em>old plaster</em></>,
      blurb: 'On the small heartbreak of a 1908 ceiling, the slow art of restoration, and what we think a buyer ought to know.',
        ...
        <div className="hc-section-head" style={{ marginBottom: 64 }}>
          ...
          <div>
            ...
            <p className="hc-section-sub" style={{ color: 'rgba(242,239,234,0.7)' }}>
              Whether you are considering selling, looking for a particular kind of house, or simply curious about a property in the Valley — write us. A Halcyon will read it personally and reply within two days.
            </p>
          </div>
        </div>
        ...
        <div className="hc-contact-grid">
          <form className="hc-form" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
            <div className="hc-form-row">
              <div className="hc-field">
                ...
                <input type="text" placeholder="Mara Halcyon" required />
              </div>
              <div className="hc-field">
                <label>Telephone</label>
                <input type="tel" placeholder="(845) 265 0162" />
              </div>
            </div>
            <div className="hc-field">
              <label>Email</label>
              <input type="email" placeholder="mara@halcyoncapital.com" required />
            </div>
            <div className="hc-form-row">
              <div className="hc-field">
                <label>I am</label>
              ...
              <div className="hc-field">
                ...
                <input type="text" placeholder="Cold Spring, Rhinebeck…" />
              </div>
            </div>
            <div className="hc-field">
          ...
          <aside className="hc-contact-aside">
            <div className="item">
              ...
              <div className="value"><em>14 Main Street</em><div className="value-sub">Cold Spring, NY 10516</div></div>
            </div>
            <div className="item">
              <div className="label">Telephone</div>
              <div className="value"><em>(845) 265 — 0162</em><div className="value-sub">Mon–Sat · 9am to 6pm</div></div>
            </div>
            <div className="item">
              <div className="label">Mara</div>
              <div className="value"><em>mara@halcyoncapital</em><div className="value-sub">Personally read · two-day reply</div></div>
            </div>
            <div className="item">
              <div className="label">Visiting</div>
              <div className="value"><em>By appointment</em><div className="value-sub">Tea is offered. Always.</div></div>
            </div>
          </aside>
        </div>
      </div>
    ...
    <footer className="hc-footer">
      <div className="hc-shell">
        <div className="hc-footer-top">
          <div>
            <div className="hc-footer-mark">Halcyon<br />Capital.</div>
            <p>A family-run real-estate office representing private estates and quiet houses across the Hudson Valley. Established 1962.</p>
          </div>
          <div>
            <h4>Browse</h4>
            <ul>
          ...
          <div>
            <h4>Visit</h4>
            <ul>
              <li>14 Main Street</li>
              <li>Cold Spring, NY 10516</li>
              <li>(845) 265 — 0162</li>
        ...
        <div className="hc-footer-bottom">
          <div>© MCMLXII — MMXXVI · Halcyon Capital · Licensed broker, NY</div>
